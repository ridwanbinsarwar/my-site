...
CREATE TABLE `customer` (
  ...
  `lat` double NOT NULL DEFAULT '23.758642',
...
CREATE TABLE `req` (
  ...
  `actual_start_time` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `req` (`location`, `lat`, `lon`, `radius`, `service_type`, `customer`, `status`, `start_time`, `end_time`, `id`, `sp_id`, `actual_start_time`) VALUES
('Bir Uttam Ziaur Rahman Road, Near Mohakhali DOHS, Dhaka 1205, Bangladesh', 23.7766, 90.39444800000001, 300, 1, 'user', 'complete', '2019-04-10', '00:31', 18, '123', NULL);
...
CREATE TABLE `todo` (
  ...
  `id` int(11) NOT NULL,
  `todo_details` varchar(200) DEFAULT NULL,
...
INSERT INTO `todo` (`req_id`, `id`, `todo_details`, `status`) VALUES
(18, 30, '1', 1),
(18, 31, '2', 1),
(18, 34, '5', 1),
(18, 35, '6', 1),
