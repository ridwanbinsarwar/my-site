...
urlpatterns = [
    ...
    path('todoadd/<int:pk>/', home_views.todo_add, name='todo_add'),
    path('todomark/<int:pk>/', home_views.todo_mark, name='todo_mark'),
    path('tododelete/<int:pk>/', home_views.todo_delete, name='todo_delete'),
    path('requestComplete/<int:pk>/', home_views.request_complete, name='request_complete'),
